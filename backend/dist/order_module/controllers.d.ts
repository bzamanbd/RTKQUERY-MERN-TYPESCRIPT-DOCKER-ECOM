...
export declare const fetchOrderQRCode: (req: Request, res: Response, next: NextFunction) => void;
export declare const myOrders: (req: Request, res: Response, next: NextFunction) => void;
export declare const myOrderById: (req: Request, res: Response, next: NextFunction) => void;
